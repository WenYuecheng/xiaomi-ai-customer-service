...
<style scoped>
.galaxy-card{background:#fff;border-color:var(--line);border-radius:18px}.galaxy-card header span{color:var(--mi-orange)}.galaxy{background:#faf9f7;border-radius:14px;margin-top:10px}.planet{background:#fff;border-color:#ded9d2;box-shadow:0 8px 20px rgba(60,52,45,.08);color:var(--ink)}.planet--intent{background:#fff2e8;border-color:#ffd1af;box-shadow:none;color:#b44a07}.orbit{border-color:#ded9d2}
</style>
