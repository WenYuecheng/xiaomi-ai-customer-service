...
<template>
  <section class="training-guide">
    <div class="guide-heading"><div><span>RECOMMENDATION EVALUATION</span><h2>推荐策略评估</h2><p>基于咨询行为离线评估推荐策略，并清楚区分真实行为与演示数据。</p></div><el-tag effect="dark" round>离线评估 · 非在线学习</el-tag></div>
...
.training-guide{background:#fff;border-color:var(--line);border-radius:18px}.guide-heading span{color:var(--mi-orange);font-weight:700}.goal-grid button{background:#faf9f7;border-color:var(--line)}.goal-grid button:hover{border-color:#ffad72}.goal-grid button.selected{background:#1d1c1a;border-color:#1d1c1a;box-shadow:0 14px 28px rgba(30,27,24,.16)}.selection-copy{background:#fff1e6;color:#b64f0b}.latest-run>div{border-color:var(--line)}.latest-run .metric strong{color:var(--mi-orange)}
</style>
<style scoped>
.goal-grid button.selected{background:#fff4eb;border-color:#ffc99f;box-shadow:none;color:#b74d08}
</style>
