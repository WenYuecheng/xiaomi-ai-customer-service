...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_behavior_events_created_at"), "behavior_events", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_behavior_events_event_type"), "behavior_events", ["event_type"], unique=False
    )
    op.create_index(
        op.f("ix_behavior_events_user_id"), "behavior_events", ["user_id"], unique=False
    )
    op.create_table(
        "knowledge_bases",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_knowledge_bases_owner_id"), "knowledge_bases", ["owner_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("queued", "running", "succeeded", "failed", "cancelled", name="jobstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_message_sources_chunk_id"), "message_sources", ["chunk_id"], unique=False
    )
    op.create_index(
        op.f("ix_message_sources_document_id"), "message_sources", ["document_id"], unique=False
    )
    op.create_index(
